 ...
 */
{
	...
	const createScrollWatchers = function() {
		DOM.contentElems.forEach((el,pos) => {
			// const scrollElemToWatch = pos ? DOM.contentElems[pos] : null;
			const scrollElemToWatch = DOM.contentElems[pos];
			// if(pos) const scrollElemToWatch = DOM.contentElems[pos]
			...
			watcher.enterViewport(function() {
				...
				anime({
					targets:"body",
					backgroundColor: shapes[pos].background
				});
